...
set(FLTK_GIT_TAG v1.9.8)  # was v1.8.4
...
# We must compile shared for tlRender
...
set(FLTK_DEPENDENCIES PNG ${WAYLAND_PROTOCOLS_DEP} ZLIB)
...
ExternalProject_Add(
    ...
    GIT_SHALLOW       OFF  # Get the full history
